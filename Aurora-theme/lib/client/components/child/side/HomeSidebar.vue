...
<template>
  ...
  <div :style="getHomeSidebarStyle" id="stickSidebar"
    ...
    <div :class="{sidebarScroll: isShowCatalog}" :style="setHomeSidebarStyle" class="home-sidebar" id="home-sidebar">
      ...
      <!--搜索-->
      <div :id="customId" :class="{'sidebar-single-enter-animate': showEnterAnimate}" class="sidebar-single-common">
				<div class="sidebar-link">
					<h2><a target="_blank" href="http://qxcloud.top/">轻想云服务器</a></h2>
					<p>地区选择多，质量高，价格实惠，配有独立服务器管理面板</p>
					<p>可选配制丰富，种类齐全，欢迎选购</p>
				</div>
      </div>
